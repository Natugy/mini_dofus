...
export class GameData {
	...
	static listeMonstres = [
		new Monstre('Piou', 20, 5, 2, 2, 2, 1, 30),
	...
	static listeSorts = [
		...
		new Soin('Soin', 3, 0, 10, EffetEnum.REGEN, TypeCiblage.CROIX),
		new Sort('Fleche de poison', 4, 2, 25, EffetEnum.POISON, TypeCiblage.CROIX),
